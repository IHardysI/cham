            ...
            <div className="header-left">
                <div className="header-left-inner-wrap">
                    <a href="" className="header-left-x">
                        <svg viewBox="0 0 20 20"><path fill="white" d="M15.8.9h3.1l-6.7 7.7L20 19.1h-6.2L9 12.7 3.5 19H.4l7.2-8.2L0 .9h6.3l4.4 5.8L15.8.9zm-1.1 16.3h1.7L5.4 2.7H3.6l11.1 14.5z"></path></svg>
                    </a>
